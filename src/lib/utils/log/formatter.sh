...
function log::formatter::get_pid() {
    ...
    # shell(12) -> scriptA(34) -> command substitution -> command substitution($PPID=12, $$=34, $BASHPID=56)
    # shell(12) -> scriptA(34) -> command substitution -> command substitution($PPID=12, $$=34, $BASHPID=56) -> sub scriptB($PPID=34, $$=78, $BASHPID=78)
